...
| ----------- | -------- | --------  | ----------------- |
| [cesanta/mongoose-os](https://github.com/cesanta/mongoose-os) | [mgos_uart.h](https://github.com/cesanta/mongoose-os/blob/master/include/mgos_uart.h) | [mgos_uart.c](https://github.com/cesanta/mongoose-os/blob/master/src/mgos_uart.c)  | [api_uart.js](https://github.com/mongoose-os-libs/mjs/blob/master/fs/api_uart.js)         |
